...
public class HardDeleteBulkTestCases extends SalesforceTestParent {
	...
	private MessageProcessor hardDeleteBulkFlow;
	...
	public void setUp() {
    	...
    	hardDeleteBulkFlow = lookupFlowConstruct("hard-delete-bulk");
		...
		try {
			...
			testObjects = (HashMap<String,Object>) context.getBean("hardDeleteBulkTestData");
	...
	public void testHardDeleteBulk() {
		...
		try {
			...
			batchInfo = getBatchInfoByOperation(hardDeleteBulkFlow);
